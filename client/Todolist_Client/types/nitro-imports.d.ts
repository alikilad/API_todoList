declare global {
  ...
  const cachedEventHandler: typeof import('nitropack/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('nitropack/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('nitropack/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('nitropack/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('../../node_modules/h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('../../node_modules/h3')['defineLazyEventHandler']
  const defineNitroErrorHandler: typeof import('nitropack/runtime')['defineNitroErrorHandler']
  ...
  const defineRenderHandler: typeof import('nitropack/runtime')['defineRenderHandler']
  const defineRequestMiddleware: typeof import('../../node_modules/h3')['defineRequestMiddleware']
  const defineResponseMiddleware: typeof import('../../node_modules/h3')['defineResponseMiddleware']
  const defineTask: typeof import('nitropack/runtime')['defineTask']
  ...
  const getRouteRules: typeof import('nitropack/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('nitropack/runtime')['nitroPlugin']
  ...
  const runTask: typeof import('nitropack/runtime')['runTask']
  ...
  const useAppConfig: typeof import('nitropack/runtime')['useAppConfig']
...
export { defineCachedFunction, defineCachedEventHandler, cachedFunction, cachedEventHandler, useRuntimeConfig, useStorage, useNitroApp, defineNitroPlugin, nitroPlugin, defineRenderHandler, getRouteRules, useAppConfig, useEvent, defineTask, runTask, defineNitroErrorHandler } from 'nitropack/runtime';
